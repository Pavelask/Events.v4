        ...
        <div class="swiper bg-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide dark-layer">
                    <img src="{{asset("front/image/0_000 copy.JPG")}}"/>
                    {{--                    <div class="card">--}}
                    ...
                    <div class="text-content">
                        ...
                        <h2 class="subtitle">VIII Всероссийского слёта молодёжи Общественной организации «Всероссийский
                            Электропрофсоюз»</h2>
                ...
                <div class="swiper-slide dark-layer">
                    ...
                    <div class="text-content">
                        ...
                        <p>
                            ...
                            интел-лект. Что такое прокрастинация и как с ней бороться. Мастер класс по
                            нейролингвистическому програм-мированию «ПЕРЕПРОШИВКА МОЗГА».
                        </p>
                        <button class="read-btn">
                            Подробнее <i class="uil uil-arrow-right"></i>
                        </button>
