<div>
    ...
    <div class="p-6 text-gray-900 dark:text-gray-100">
        ...
        <div class="px-6 py-24 sm:px-6 sm:py-32 lg:px-8 rounded-md shadow-md border border-gray-100">
            <div class="mx-auto max-w-4xl text-center">
                <h2 class="text-2xl uppercase font-bold tracking-tight text-gray-700 sm:text-3xl">
                    {{ $Event->name }}
                </h2>
                <h2 class="mx-auto mt-6 text-2xl font-bold leading-8 text-gray-400">
                    {{ $Event->fulldate }}
                </h2>
                <h2 class="mx-auto text-xl font-bold leading-8 text-gray-300">
